    ...
    <Layout>
      <Wrapper>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="featrSnglTwoColsCont featrSnglTwoColContLeft">
                  ...
                  <p>
                    An efficient way to manage and plan tasks. Easily access
                    your task list from the palm of your hand.
                  </p>

                  <ul>
                    <li>
                      <span>⁃</span> Create daily simple to-do lists for
                      projects of any size
                    </li>
                    <li>
                      <span>⁃</span> Assign tasks directly through the app and
                      track progress
                    </li>
                    <li>
                      <span>⁃</span> Real time communication
                    </li>
                    <li>
                      <span>⁃</span> Build “look ahead” schedules with date
                      ranges and export for key project updates
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="featrSnglTwoColsCont featrSnglTwoColContRight">
                  ...
                  <ul>
                    <li>
                      <span>⁃</span> Generate powerful to-do lists for projects
                      of any size
                    </li>
                    <li>
                      <span>⁃</span> Write details and set due dates
                    </li>
                    <li>
                      <span>⁃</span> Assign project specific tasks to team
                      members
                    </li>
                  </ul>
                </div>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="featrSnglTwoColsCont featrSnglTwoColContLeft">
                  ...
                  <ul>
                    <li>
                      <span>⁃</span> Collaborate simply but efficiently from
                      field to office
                    </li>
                    <li>
                      <span>⁃</span> Assign task, set due-dates, and prioritize
                      work flow
                    </li>
                    <li>
                      <span>⁃</span> Real time task tracking allows you to see
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="featrSnglTwoColsCont featrSnglTwoColContRight">
                  ...
                  <ul>
                    <li>
                      <span>⁃</span> Easily view tasks that are set for weeks or
                      months ahead
                    </li>
                    <li>
                      <span>⁃</span> Build “look ahead” schedules with date
                    ...
                    <li>
                      <span>⁃</span> Export data for project updates
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <AnswerSection
          ...
          GeneralDescFirst={
            "Communicate and track tasks quickly with the streamlined Task feature."
          }
          ContractorsDesc={
            "The Task feature enables efficient field to office communication. Easily access project information and to-do’s from the palm of your hand."
          }
          DevelopersDesc={
            "Get real time visibility of all current and past project tasks to ensure compliance, productivity, and profitability."
          }
        />
        ...
        {/* </Flex> */}
        <Infographic InfoGraphWrapClass={"FtrdInfoGraphSec"} />
      </Wrapper>
    </Layout>
  )
}
