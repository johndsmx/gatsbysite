...
const AboutFooter = props => {
  return (
    <Wrapper>
      <BookDemoWrapperAbout>
        {/* <h4>{props.footerText}</h4> */}
        <div class="footer_top_wrap">
          <div class="left_col">
          <h4 class="footer_top_title mb-4">You be­long with us.</h4>
          <div class="footer_top_desc">
              Come on. You know you want to work here. See what roles are open.
...
const BookDemoWrapperAbout = styled.div`
